...
const UsersPage = () => {
  ...
  const handleDeleteUser = async (userId) => {
    ...
    try {
      ...
      // axiosConfig already extracts the specific backend error message into error.message
                    ...
                    <td>
                      <div className="action-buttons-inline">
                        ...
                        <button
                          ...
                          title={currentUser && currentUser.id === user._id ? "Cannot delete yourself" : "Delete user"}
                        >
                          Delete
                        </button>
                      </div>
