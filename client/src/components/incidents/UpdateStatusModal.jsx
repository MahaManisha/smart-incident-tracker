      ...
      <form onSubmit={handleSubmit}>
        ...
        {status === INCIDENT_STATUS.RESOLVED && (
          <div className="alert alert-success">
            ...
            <p style={{ marginTop: '0.5rem', fontSize: '0.9em', color: '#155724' }}>
              <strong>Tip:</strong> After resolving, you can attach detailed post-mortem documentation and files directly on the Incident Details page.
            </p>
          </div>
        )}
      </form>
